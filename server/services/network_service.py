...
def congestion_vs_structure(args):
    ...
    for network_doc in network_docs:
        ...
        results.append({
            ...
            "total_street_length_m": basic_stats["total_street_length_m"],
            "avg_street_length_m": basic_stats["avg_street_length_m"],
            "street_density_m_per_km2": basic_stats["street_density_m_per_km2"],
            "intersection_density_per_km2": basic_stats["intersection_density_per_km2"],
            "avg_node_degree": basic_stats["avg_node_degree"],
            "circuity": basic_stats["circuity"],
            "avg_node_connectivity": connectivity.get("avg_node_connectivity"),
            "bridge_count": connectivity.get("bridge_count"),
            "bridge_ratio": connectivity.get("bridge_ratio"),
